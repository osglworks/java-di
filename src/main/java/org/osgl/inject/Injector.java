...
public interface Injector {
     ...
     *
     * @param type
     *      the class of the bean that provider provides
     * @param <T>
     *      the generic type of the bean
     * @return
     *      the provider that provides the bean
     */
     ...
     *      the annotation type
     * @return
     *      `true` if the annotation type is a qualifier or `false` otherwise
     */
     ...
     *      the annotation type
     * @return
     *      `true` if the annotation type specifies post construct processor
     */
     ...
     *      the annotation type
     * @return `true`
     *      if the annotation type indicate a scope
     */
     ...
     *      the annotation type
     * @return
     *      `true` if the annotation type is inherited scope stopper
     */
     ...
     *
     * @param alias
     *      the alias of the scope annotation
     * @return
     *      the scope annotation type if found
     */
