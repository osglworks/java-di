...
public class AnnoInvocationHandler implements InvocationHandler {
    ...
    public AnnoInvocationHandler(Class<? extends Annotation> type, Map<String, Object> memberValues) {
        this.type = type;
    ...
    private Boolean equalsImpl(Object o) {
        ...
        for (Method memberMethod : getMemberMethods()) {
            ...
            AnnoInvocationHandler hisHandler = asOneOfUs(o);
            if (hisHandler != null) {
     ...
     * proxy with a handler of type AnnoInvocationHandler.
     * Returns null otherwise.
     */
    private AnnoInvocationHandler asOneOfUs(Object o) {
        if (Proxy.isProxyClass(o.getClass())) {
            InvocationHandler handler = Proxy.getInvocationHandler(o);
            if (handler instanceof AnnoInvocationHandler)
                return (AnnoInvocationHandler) handler;
        }
        return null;
    }
