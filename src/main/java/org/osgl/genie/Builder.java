...
public abstract class Builder<T> implements Provider<T> {
    ...
    public Builder(Class<? extends T> targetClass, Set<Annotation> annotations, List<Type> typeParameters) {
    ...
    public interface Factory<T> {
         ...
         * @return a builder
         */
        Builder<T> createBuilder(Class<T> targetClass, Set<Annotation> annotations, List<Type> typeParams);
        ...
        class Manager {
            ...
            private static class WeightedFactory<T> implements Factory<T>, Comparable<WeightedFactory> {
                ...
                @Override
                public Builder<T> createBuilder(Class<T> targetClass, Set<Annotation> annotations, List<Type> typeParams) {
